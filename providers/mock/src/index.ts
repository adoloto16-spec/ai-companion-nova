import type {
  ...
  ProviderCapabilities, STTProvider, STTRequest, TTSProvider, TTSRequest, Transcript, VisionProvider,
...
export class FakeEmbeddingProvider implements EmbeddingProvider {
  ...
  dimensions(){return 4;}
  async embed(texts:string[]){return texts.map(t=>[t.length,0,0,0]);}
