...
const required=[
  ...
  "contracts/schemas/chat-request.schema.json","contracts/schemas/chat-response.schema.json","contracts/schemas/chat-error.schema.json","contracts/schemas/core-book-entry.schema.json","contracts/schemas/context-source.schema.json","contracts/schemas/context-zone.schema.json","contracts/schemas/context-budget.schema.json","contracts/schemas/context-build-request.schema.json","contracts/schemas/context-candidate.schema.json","contracts/schemas/assembled-context.schema.json","contracts/src/schema-validator.ts",
  "contracts/src/generated-schemas.ts","runtime/bootstrap/src/index.ts","core/src/context-engine.ts","host/config/src/index.ts","host/credentials/src/index.ts","apps/desktop-ui/src/main.tsx","host/characters/src/index.ts","host/core-book/src/index.ts",
