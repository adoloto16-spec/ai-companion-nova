...
const required=[
  ...
  "contracts/src/generated-schemas.ts","runtime/bootstrap/src/index.ts","host/config/src/index.ts","host/credentials/src/index.ts","apps/desktop-ui/src/main.tsx","host/characters/src/index.ts","host/core-book/src/index.ts",
