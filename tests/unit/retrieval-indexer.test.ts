...
async function main(){
  ...
  const entry=await coreBook.createCoreBookEntry("character.a",{id:"core.a.1",title:"Berlin canon",content:"Nova lives in Berlin",tags:["berlin"],source:"user"});
  ...
  const canonical=await coreBook.createCoreBookEntry("character.a",{id:"core.a.2",title:"Canonical",content:"Canonical survives",source:"user"});
